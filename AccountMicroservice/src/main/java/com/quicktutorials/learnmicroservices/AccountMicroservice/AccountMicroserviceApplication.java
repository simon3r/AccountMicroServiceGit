...
public class AccountMicroserviceApplication implements CommandLineRunner {
	...
	private static Logger log = LoggerFactory.getLogger(AccountMicroserviceApplication.class);
	...
	public void run(String... args) throws Exception {
		log.info("hello");
		//nota il metodo save è un metodo di base di JPA repository, non definito esplicitamente da JPA repository
    ...
    @Bean //Definisco un nuovo bean che potrò iniettare nel codice successivamente, questo perchè questa classe è anche di configurazione
